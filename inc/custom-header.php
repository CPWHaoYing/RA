 ...
 *
 * @uses ra_header_style()
 * @uses ra_admin_header_style()
 * @uses ra_admin_header_image()
 *
 * @package RA
 */
function ra_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'ra_custom_header_args', array(
		'default-image'          => '',
		'default-text-color'     => '000',
		'width'                  => 1000,
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'ra_header_style',
		'admin-head-callback'    => 'ra_admin_header_style',
		'admin-preview-callback' => 'ra_admin_header_image',
	) ) );
}
