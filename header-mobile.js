	...
	// submenu -> Shows MENU Icon
  	...
  	$("#menuBtn_touchArea").click(function(){
	    ...
	    $('head').prepend('<meta name="viewport" content="width=640px, minimum-scale=0.5, maximum-scale=1, user-scalable=0.5" />');
  		...
  		if(href_name == "dr-apa" || href_name == "dr-rosenthal"	|| href_name == "rosenthal-institute-nyu" || href_name == "newsletter")
  			$('#menu-mobile > li:eq(0)').click();
  		else if(href_name == "the-making-of-a-smile" || href_name == "facial-aesthetic-design" || href_name == "smile-makeover" || href_name == "faq")
  			$('#menu-mobile > li:eq(1)').click();
  		else if(href_name == "gallery-1" || href_name == "gallery-1"	|| href_name == "client-testimonials")
