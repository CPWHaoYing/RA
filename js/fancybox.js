...
;(function($) {
	var tmp, loading, overlay, wrap, outer, content, close, title, nav_left, nav_right,
		...
		_show = function() {
			...
			if (currentOpts.overlayShow) {
				...
				// fancybox-overlay height fixed by Jeewhan
				//$("#fancybox-overlay").css({'height':100});
				// fancybox-overlay height fixed End
		...
		_finish = function () {
			...
			if (currentOpts.hideOnContentClick)	{
				content.bind(click_event, $.fancybox.close);
			}

			if (currentOpts.hideOnOverlayClick)	{
				overlay.bind(click_event, $.fancybox.close);
			}
		...
		_get_zoom_to = function () {
			...
			var top_ = window.pageYOffset || document.documentElement.scrollTop
			
			//to.top = 73; // top-padding from press page JH
			to.top = top_ + 73;
	...
	var click_event = isMobile ? "click" : "click";
	...
	$.fn.fancybox = function(options) {
		...
		$(this)
			...
			.unbind(click_event + '.fb')
			.bind(click_event + '.fb', function(e) {
				e.preventDefault();
