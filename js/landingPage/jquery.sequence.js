...
;(function($) {
	...
	*/
	...
	var defaults = {
		...
		autoPlayDirection: 2, //The direction in which Sequence should auto play
		...
		showNextButtonOnInit: false, //if true, Sequence will make the next button display: block; once Sequence has loaded (give the next button selector display: none; in the CSS to hide it until its usable)
		...
		showPrevButtonOnInit: false, //if true, Sequence will make the previous button display: block; once Sequence has loaded (give the previous button selector display: none; in the CSS to hide it until its usable)
		...
		pauseOnHover: false, //pause Sequence when the Sequence container is hovered over
		...
		showPauseButtonOnInit: false, //if true, Sequence will make the pause button display: block; once Sequence has loaded (give the pause button selector display: none; in the CSS to hide it until its usable)
		...
		showPaginationOnInit: false,  //if true, Sequence will make the pagination display: block; once Sequence has loaded (give the pagination selector display: none; in the CSS to hide it until its usable)
